...
async function scrapeGpt3(messages: Message[]) {
  try {
...
export default [
  {
    ...
    tags: ["AI", "Chatbot", "NLP"],
    example: "?prompt=You are a cheerful AI&content=Hello there!",
    parameters: [
      {
        name: "prompt",
        in: "query",
    ...
    requestBody: {
      ...
      content: {
        "application/json": {
          schema: {
            type: "array",
            description: "An array of message objects for the GPT-3 model",
            items: {
              type: "object",
              properties: {
                role: {
